...
class ExpoKeywordBasedRecognizerModule extends EventEmitter {
    recognition = null;
    isActive = false;
    currentState = KeywordRecognizerStateEnum.IDLE;
    options = null;
    silenceTimer = null;
    ...
    switchToSpeechRecognition(initialText) {
...
//# sourceMappingURL=ExpoKeywordBasedRecognizerModule.web.js.map